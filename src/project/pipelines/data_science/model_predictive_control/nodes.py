from project.packages.modelling.models.model_predictive_control.mpc import (
...
def model_predictive_control_exploration(df, model, params, data_schemas, *preprocessors):
    ...
    model_explorer = ModelPredictiveControlExplorer(
        model=model, preprocessors=preprocessors, params=params, data_schemas=data_schemas
    )
